    ...
    >
      ...
      >
        ...
        {fixture ? (
          ...
          <div className="space-y-1">
            ...
            <div className="h-2 w-4 rounded bg-white/[0.03]" />
      ...
      <div className="relative">
        ...
        >
          {/* Avatar */}
          <div
            className="w-6 h-6 rounded-full shrink-0 flex items-center justify-center text-[10px] font-bold text-[#050508]"
            ...
            {showProfileMenu && (
              ...
              >
                <button
                  ...
                  className="flex items-center gap-2 w-full text-left text-[12px] text-white/50 hover:text-red-400 hover:bg-red-500/[0.06] px-3 py-2 rounded-lg transition-colors"
                >
